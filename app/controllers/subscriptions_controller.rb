...
class SubscriptionsController < ApplicationController
  ...
  after_filter  only: [:create] { SubscriptionMailer.successful_create_message(@subscription) }
  after_filter  only: [:create_with_bank_slip] { SubscriptionMailer.successful_create_message_for_bank_slip(@subscription) }
