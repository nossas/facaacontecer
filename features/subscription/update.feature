Feature: Existing subscription for the current campaign
  ...
  Scenario Outline: An Existing user subscribe with credit card info in the subscription form
    ...
    Examples:
      ...
      | 1     |   1       | processing | Aguarde só um instantinho enquanto geramos o link para o seu banco   | Luiz       | Fonseca   | 919.133.769-07 | 12/11/1988 | this@user.com | (21) 999999999 | Única      | R$ 90 | Débito            | Itaú | 22222-222 | Rua | 300 | Ape | Botafogo | Rio de Janeiro | RJ  |
      | 2     |   1       | processing | Aguarde só um instantinho enquanto geramos o link para o seu boleto  | Luiz       | Fonseca   | 919.133.769-07 | 12/11/1988 | email@email.com | (21) 999999999 | Semestral  | R$ 90 | Boleto            | Itaú | 22222-222 | Rua | 300 | Ape | Botafogo | Rio de Janeiro | RJ  |
